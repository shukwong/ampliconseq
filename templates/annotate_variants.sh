...
gatk --java-options "-Xmx!{java_mem}m" VariantsToTable \
    ...
    --fields HomopolymerAtVariant

echo -e "Chromosome\tPosition\tRef\tAlt\t5' context\tAlleles\t3' context\tIndel length\tHomopolymer length\tHomopolymer at variant" > !{other_annotations}
awk 'BEGIN { FS = "\t"; OFS = "\t" } FNR > 1 { print $1, $2, $3, $4, $5, $3"/"$4, $6, $7, $8, $9 }' distinct_variants.annotated.txt >> !{other_annotations}
